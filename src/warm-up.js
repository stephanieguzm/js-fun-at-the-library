...
// var ...
var title = "Race after Technology";
var pages = 320;
...
var sequel = `${title}: Part II - Race Against Technology`;
console.log(sequel);
...
if (pages < 1000) {
  ...
  console.log("Ok, mayble I could read that in a day and a half")
}
...
if (isFavorite = true) {
  ...
  console.log("I recently read the Algorithms of Oppression book.")
}
...
var books = ["Algorithms of Oppression", "Race After Technology", "Biased", "You Sound Like a White Girl", "Big Feelings"];
...
var belowTwoHundred = [34, 67, 105, 7, 90, 129, 120, 50, 11, 84, 187, 199];
